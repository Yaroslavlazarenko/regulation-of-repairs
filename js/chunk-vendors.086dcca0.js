 ...
 * limitations under the License.
 */
function dd(t){t=ah(t,dh);const e=ah(t.firestore,vh);return Xl(_h(e),t._key).then((n=>_d(e,t,n)))}class fd extends sd{constructor(t){super(),this.firestore=t}convertBytes(t){return new bh(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new dh(this.firestore,null,e)}}function pd(t){t=ah(t,hh);const e=ah(t.firestore,vh),n=_h(e),r=new fd(e);return Qh(t._query),Zl(n,t._query).then((n=>new ld(e,r,t,n)))}function md(t,e,n){t=ah(t,dh);const r=ah(t.firestore,vh),i=od(t.converter,e,n);return yd(r,[xh(Nh(r),"setDoc",t._key,i,null!==t.converter,n).toMutation(t._key,sa.none())])}function gd(t,e,n,...r){t=ah(t,dh);const i=ah(t.firestore,vh),s=Nh(i);let o;return o="string"==typeof(e=(0,a.Yj)(e))||e instanceof Eh?Lh(s,"updateDoc",t._key,e,n,r):Ph(s,"updateDoc",t._key,e),yd(i,[o.toMutation(t._key,sa.exists(!0))])}function vd(t){return yd(ah(t.firestore,vh),[new ya(t._key,sa.none())])}function yd(t,e){return function(t,e){const n=new ai;return t.asyncQueue.enqueueAndForget((async()=>Tl(await Yl(t),e,n))),n.promise}(_h(t),e)}function _d(t,e,n){const r=n.docs.get(e._key),i=new fd(t);return new cd(t,i,e._key,r,new ad(n.hasPendingWrites,n.fromCache),e.converter)}
/**
 * @license
 * Copyright 2022 Google LLC
 *
...
//# sourceMappingURL=chunk-vendors.086dcca0.js.map